...
- [2. Quick Start — Run on Your Own Data](#2-quick-start--run-on-your-own-data)
- [3. Input & Output Formats](#3-input--output-formats)
- [4. Parameters](#4-parameters)
- [5. Reproducing the Paper](#5-reproducing-the-paper)
- [6. Repository Structure](#6-repository-structure)
- [7. Experiments & Figures](#7-experiments--figures)
- [8. Benchmark Methods](#8-benchmark-methods)
...
## 🚀 2. Quick Start — Run on Your Own Data
...
> **Prerequisites — keep these reference files in `./data/`.** The model loads them by relative path, so run from the repository root and make sure the following exist:
...
> **Note on large files.** Raw TCGA files and full networks are large and may not be committed to Git. If hosted externally, add the download location here.

---

## 📊 7. Experiments & Figures
